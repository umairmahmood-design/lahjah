  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        // Auto-advance to in_review when the reviewer opens it
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-sm text-gray-500 mb-6">Only Copy Team members can review requests.</p>
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto px-6 py-16 text-center">
          ...
          <button onClick={() => router.push("/dashboard/review")} className="mt-4 text-sm text-gray-400 hover:text-gray-600 underline">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-5">
        ...
        {request.revisionNotes && (
          <div className="bg-red-50 border border-red-200 rounded-2xl p-5">
            <p className="text-xs font-medium text-red-600 uppercase tracking-wide mb-2">Previous revision notes</p>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-4">
            <div>
              ...
              <textarea
                ...
                rows={4}
                placeholder="e.g. The Arabic CTA sounds too formal. Please try a warmer, more conversational tone. The English heading is great."
            ...
            <div className="flex gap-3">
              <button
                ...
                disabled={acting}
                className="flex-1 py-3 rounded-xl bg-[#F4F5F6] text-ink font-semibold text-sm hover:bg-gray-200 transition-colors disabled:opacity-50"
              >
